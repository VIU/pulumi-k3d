...
namespace Pulumi.K3d
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.K3d.version.txt");
    ...
    internal sealed class K3dResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public K3dResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
